//===-- URCLMachineFuctionInfo.h - URCL machine function info -----*- C++ -*-===//
//
...
#ifndef LLVM_URCL_MACHINE_FUNCTION_INFO_H
#define LLVM_URCL_MACHINE_FUNCTION_INFO_H

#include "llvm/CodeGen/MachineFunction.h"

namespace llvm {

/// Contains URCL-specific information for each MachineFunction.
...
#endif // LLVM_URCL_MACHINE_FUNCTION_INFO_H
